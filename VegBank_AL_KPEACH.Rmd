...
VegBank_plot_data_AL <- read_excel("CVS-ALplots.xlsx", sheet = "plot data")
VegBank_plot_species_list_AL <- read_excel("CVS-ALplots.xlsx",  sheet = "plot species list")
...
write.csv(VegBank_multiple_species_AL ,"multiple_sp_AL_KPEACH.csv", row.names = FALSE)
...
#Save as csv for Jeff to inspect
write.csv(no_match,"no_match_AL_KPEACH.csv", row.names = FALSE)
...
#As csv
write.csv(VegBank_with_SpCode_AL,"VegBank_AL_KPEACH.csv", row.names = FALSE)

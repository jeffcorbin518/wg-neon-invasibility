...
VegBank_FL$bestname <- gsub("Opuntia mesacantha ssp.mesacantha", "Opuntia", VegBank_FL$bestname)

VegBank_FL$bestname <- gsub("Opuntia mesacantha", "Opuntia", VegBank_FL$bestname)
...
VegBank_FL$bestname <- gsub("Ionactis linariifolia", "Ionactis", VegBank_FL$bestname)

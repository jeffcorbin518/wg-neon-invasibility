...
>>>>>>> 2045c14182eb80c4f6a36fe6d25203cb47eb702c
...
plot_sizes <- unique(VegBank_with_SpCode_FL$`Taxon Observation Area`)

odd_plot_sizes <- VegBank_with_SpCode_FL %>%
  filter(`Taxon Observation Area` == '-1')

write.csv(odd_plot_sizes,"odd_plot_sizes_FL_KPEACH.csv", row.names = FALSE)

...
VegBank_plot_data_NCMts <- read_excel(file.path(data_raw, "CVS-NCMts_no_notes.xlsx"), sheet = "plot data", guess_max = min(2000, n_max = NULL))
VegBank_plot_species_list_NCMts <- read_excel(file.path(data_raw, "CVS-NCMts_no_notes.xlsx"),  sheet = "plot species list", guess_max = min(2000, n_max = NULL))
...
VegBank_plot_data_NCMts$`Observation Start Date` <- as.numeric(VegBank_plot_data_NCMts$`Observation Start Date`)

VegBank_plot_data_NCMts <- VegBank_plot_data_NCMts %>% drop_na(`Observation Start Date`)

samlevel <- VegBank_plot_data_NCMts$`Sampling Level`
...
VegBank_NCMts <- VegBank_NCMts %>% add_column(Dataset = 'VEGBANK', .before = "VegBankUniqueID")  %>% add_column(Zone = 'L48', .before = "VegBankUniqueID")

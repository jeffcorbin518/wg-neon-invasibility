...
VegBank_plot_data_NCMts <- read_excel("/home/shares/neon-inv/raw_VegBank_data/CVS-NCMts.xlsx", sheet = "plot data")
VegBank_plot_species_list_NCMts  <- read_excel("/home/shares/neon-inv/raw_VegBank_data/CVS-NCMts.xlsx",  sheet = "plot species list")
...
VegBank_NCMts$ExoticStatus <- gsub("NATIVE", "N", VegBank_NCMts$ExoticStatus)
VegBank_NCMts$ExoticStatus <- gsub("exotic", "NI", VegBank_NCMts$ExoticStatus)
VegBank_NCMts$ExoticStatus <- gsub("EXOTIC", "NI", VegBank_NCMts$ExoticStatus)
...
write.csv(VegBank_multiple_species_NCMts ,"/home/shares/neon-inv/output_files/multiple_sp_NCMts_KPEACH.csv", row.names = FALSE)
...
#Save as csv for Jeff to inspect
write.csv(no_match,"/home/shares/neon-inv/output_files/no_match_NCMts_KPEACH.csv", row.names = FALSE)
...
write.csv(odd_plot_sizes,"/home/shares/neon-inv/output_files/odd_plot_sizes_NCMts_KPEACH.csv", row.names = FALSE)
...
#As csv
write.csv(VegBank_with_SpCode_NCMts,"/home/shares/neon-inv/output_files/VegBank_NCMts_KPEACH.csv", row.names = FALSE)

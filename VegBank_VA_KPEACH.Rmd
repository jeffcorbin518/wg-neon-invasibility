...
VegBank_plot_data_VA <- read_excel("/home/shares/neon-inv/raw_VegBank_data/CVA-VAplots.xlsx", sheet = "plot data")
VegBank_plot_species_list_VA <- read_excel("/home/shares/neon-inv/raw_VegBank_data/CVA-VAplots.xlsx",  sheet = "plot species list")
...
VegBank$ExoticStatus <- gsub("NATIVE", "N", VegBank$ExoticStatus)
VegBank$ExoticStatus <- gsub("exotic", "NI", VegBank$ExoticStatus)
VegBank$ExoticStatus <- gsub("EXOTIC", "NI", VegBank$ExoticStatus)
...
write.csv(VegBank_multiple_species_VA,"/home/shares/neon-inv/output_files/multiple_sp_VA_KPEACH.csv", row.names = FALSE)
...
#Save as csv for Jeff to inspect
write.csv(no_match,"/home/shares/neon-inv/output_files/no_match_VA_KPEACH.csv", row.names = FALSE)
...
#As csv
write.csv(VegBank_with_SpCode_VA,"/home/shares/neon-inv/output_files/VegBank_VA_KPEACH.csv", row.names = FALSE)

...
VegBank_plot_data_GA <- read_excel(file.path(data_raw, "CVS-GAplots.xlsx"), sheet = "plot data")
VegBank_plot_species_list_GA <- read_excel(file.path(data_raw, "CVS-GAplots.xlsx"),  sheet = "plot species list")
...
VegBank_GA <- VegBank_GA %>% add_column(Dataset = 'VEGBANK', .before = "VegBankUniqueID")  %>% add_column(Zone = 'L48', .before = "VegBankUniqueID")

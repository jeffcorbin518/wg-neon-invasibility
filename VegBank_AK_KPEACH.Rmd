...
#testing out the new and improved authority doc
...
#Trying to find duplicates creeping up in the final merged data
duplicates <- VegBank_AK6 %>% group_by(VegBankUniqueID, SpCode) %>% summarise(n_obs = n()) %>% filter(n_obs > 1)

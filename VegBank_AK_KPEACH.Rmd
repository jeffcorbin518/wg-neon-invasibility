...
shared_data_raw <- "/home/shares/neon-inv/raw_VegBank_data"

#New file path to shared folder
VegBank_plot_data_AK <- read_excel(file.path(shared_data_raw, "CVS-AKplots.xlsx"), sheet = "plot data")

VegBank_plot_species_list_AK <- read_excel(file.path(shared_data_raw, "CVS-AKplots.xlsx"),  sheet = "plot species list")
...
#As csv
write.csv(VegBank_with_SpCode_AK,"/home/shares/neon-inv/output_files/VegBank_AK_KPEACH.csv", row.names = FALSE)

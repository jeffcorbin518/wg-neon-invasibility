...
VegBank_plot_data_TX <- read_excel("CVS-TXplots.xlsx", sheet = "plot data")
VegBank_plot_species_list_TX  <- read_excel("CVS-TXplots.xlsx",  sheet = "plot species list")
...
#Save as csv for Jeff to inspect
write.csv(no_match,"no_match_TX_KPEACH.csv", row.names = FALSE)
...
write.csv(odd_plot_sizes,"odd_plot_sizes_TX_KPEACH.csv", row.names = FALSE)
...
#As csv
write.csv(VegBank_with_SpCode_TX,"VegBank_TX_KPEACH.csv", row.names = FALSE)

...
VegBank_plot_data_NC_coastal <- read_excel(file.path(data_raw, "CVS-NCCoastlplainPlots.xlsx"), sheet = "plot data")
VegBank_plot_species_list_NC_coastal <- read_excel(file.path(data_raw, "CVS-NCCoastlplainPlots.xlsx"),  sheet = "plot species list")
...
VegBank_NC_coastal <- VegBank_NC_coastal %>% add_column(Dataset = 'VEGBANK', .before = "VegBankUniqueID")  %>% add_column(Zone = 'L48', .before = "VegBankUniqueID")

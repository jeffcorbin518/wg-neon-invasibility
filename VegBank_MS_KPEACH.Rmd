...
VegBank_MS <- VegBank_MS %>% add_column(Dataset = 'VEGBANK', .before = "VegBankUniqueID")  %>% add_column(Zone = 'L48', .before = "VegBankUniqueID")
...
VegBank_MS$bestname <- gsub("Nabalus", "Prenanthes", VegBank_MS$bestname)

...
WestVirginia_comp4  <- WestVirginia_comp3 %>% group_by(Dataset, Zone, UniqueID, Year, Lat, Long, SpCode, Duration, GrowthForm, ExoticStatus, ExoticStatus_Origin, bestname, `Taxon Observation Area`) %>%
...
#As csv
write.csv(WestVirginia_comp4 ,"/home/shares/neon-inv/output_files/NCVS_WV_KPEACH_EB_reduced.csv", row.names = FALSE)

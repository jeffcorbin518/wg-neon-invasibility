...
test <- KPEACH_ExoticStatus_authority %>% 
...
test4 <- left_join(test, list, by = 'SpCode')

test5 <- test4 %>%
  mutate('USDA_Duration' = ifelse(!is.na(USDA_Duration.x), USDA_Duration.x, USDA_Duration.y)) %>%
   mutate('USDA_Growth_Form' = ifelse(!is.na(USDA_Growth_Form.x), USDA_Growth_Form.x, USDA_Growth_Form.y)) %>%
   mutate('USDA_Exotic_Status' = ifelse(!is.na(USDA_Exotic_Status.x), USDA_Exotic_Status.x, USDA_Exotic_Status.y))

test6 <- test5 %>% select(-'USDA_Duration.x', -'USDA_Duration.y', -'USDA_Growth_Form.x', -'USDA_Growth_Form.y', -'USDA_Exotic_Status.x', -'USDA_Exotic_Status.y') 

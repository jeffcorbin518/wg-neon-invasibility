...
taxonomy_temp10_revised <- taxonomy_temp10_revised %>% select('Symbol', 'inv_L48', 'GrowthForm', 'Scientific.Name') %>% rename('SpCode' = 'Symbol', 'NEON_GrowthForm' = 'GrowthForm', 'bestname' = 'Scientific.Name')

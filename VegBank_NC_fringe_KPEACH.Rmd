...
VegBank_plot_data_NC_fringe <- read_excel("CVS-NCFringePlots.xlsx", sheet = "plot data")
VegBank_plot_species_list_NC_fringe  <- read_excel("CVS-NCFringePlots.xlsx",  sheet = "plot species list")
...
#Save as csv for Jeff to inspect
write.csv(no_match,"no_match_NC_fringe_KPEACH.csv", row.names = FALSE)
...
#As csv
write.csv(VegBank_with_SpCode_NC_fringe,"VegBank_NC_fringe_KPEACH.csv", row.names = FALSE)
